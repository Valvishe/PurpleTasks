...
function activate(context) {
    ...
    context.subscriptions.push(vscode.window.registerWebviewViewProvider("purpletasks-sidebar", sidebarProvider));
    ...
    context.subscriptions.push(vscode.commands.registerCommand("purpletasks.showLoginPanel", () => {
        LoginPanel_1.LoginPanel.createOrShow(context.extensionUri);
    }));
    let refreshWebView = vscode.commands.registerCommand("purpletasks.refreshWebView", () => {
